...
difference_between = abs(offset*clk_ts-gate_driver_delay);
        ...
        g3.rise = d_length + dt1_length;
        g3.fall = (-1) + d_length + dt1_length + d_prime_length + dt2_length + d_length + dt1_length + d_prime_length;
        ...
        g6.rise = d_length + dt1_length + d_prime_length + dt2_length + d_length + dt1_length ;
        g6.fall = (-1) + d_length + dt1_length + d_prime_length;

        g7.rise = 0;
        g7.fall = (-1) + d_length;

        g8.rise = d_length + dt1_length + d_prime_length + dt2_length;
        ...
        g10.fall = (-1) + d_length + dt1_length + d_prime_length + dt2_length + d_length + dt1_length + d_prime_length;
