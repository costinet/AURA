...
%% Optimization Loop
    while(big_loop<max_iteration)
        ...
        for i = 1:FETs_number
            ...
            [PerturbRon]=COMPEL_2023_SCBuckHybridBuck_D_Sweep_Final(x,Coss_adj,Ron_adj,L_adj,RL_adj);


            Coss_adj = [deltaCoss deltaCoss deltaCoss deltaCoss deltaCoss].*adjust_FET;
            Ron_adj = [0 0 0 0 0].*adjust_FET;

            [PerturbCoss]=COMPEL_2023_SCBuckHybridBuck_D_Sweep_Final(x,Coss_adj,Ron_adj,L_adj,RL_adj);
