...
options = optimoptions('ga','PlotFcn',@gaplotbestf,'TolCon',1e-9,'Display','iter',...
    'MaxGenerations',10000,'MaxTime',60*60*6, 'MaxStallGenerations',50, 'PopulationSize', 100);
...
[x,fval,exitflag,output,population,scores] = ...
    ga(@COMPEL_2023_SCBuckHybridBuck_D_Sweep_GA, Nvars, A, b, Aeq, beq, LB.*sf, UB.*sf, [], INTCON, options);
