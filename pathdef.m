...
p = [...
%%% BEGIN ENTRIES %%%
     '\\client\d$\GitHub\AURA;', ...
     '\\client\d$\GitHub\AURA\.git;', ...
     '\\client\d$\GitHub\AURA\.git\hooks;', ...
     '\\client\d$\GitHub\AURA\.git\info;', ...
     '\\client\d$\GitHub\AURA\.git\logs;', ...
     '\\client\d$\GitHub\AURA\.git\logs\refs;', ...
     '\\client\d$\GitHub\AURA\.git\logs\refs\heads;', ...
     '\\client\d$\GitHub\AURA\.git\logs\refs\remotes;', ...
     '\\client\d$\GitHub\AURA\.git\logs\refs\remotes\origin;', ...
     '\\client\d$\GitHub\AURA\.git\objects;', ...
     '\\client\d$\GitHub\AURA\.git\objects\06;', ...
     '\\client\d$\GitHub\AURA\.git\objects\0e;', ...
     '\\client\d$\GitHub\AURA\.git\objects\10;', ...
     '\\client\d$\GitHub\AURA\.git\objects\28;', ...
     '\\client\d$\GitHub\AURA\.git\objects\2e;', ...
     '\\client\d$\GitHub\AURA\.git\objects\30;', ...
     '\\client\d$\GitHub\AURA\.git\objects\3a;', ...
     '\\client\d$\GitHub\AURA\.git\objects\3f;', ...
     '\\client\d$\GitHub\AURA\.git\objects\50;', ...
     '\\client\d$\GitHub\AURA\.git\objects\53;', ...
     '\\client\d$\GitHub\AURA\.git\objects\57;', ...
     '\\client\d$\GitHub\AURA\.git\objects\67;', ...
     '\\client\d$\GitHub\AURA\.git\objects\6f;', ...
     '\\client\d$\GitHub\AURA\.git\objects\70;', ...
     '\\client\d$\GitHub\AURA\.git\objects\78;', ...
     '\\client\d$\GitHub\AURA\.git\objects\7c;', ...
     '\\client\d$\GitHub\AURA\.git\objects\7e;', ...
     '\\client\d$\GitHub\AURA\.git\objects\81;', ...
     '\\client\d$\GitHub\AURA\.git\objects\82;', ...
     '\\client\d$\GitHub\AURA\.git\objects\84;', ...
     '\\client\d$\GitHub\AURA\.git\objects\8c;', ...
     '\\client\d$\GitHub\AURA\.git\objects\91;', ...
     '\\client\d$\GitHub\AURA\.git\objects\97;', ...
     '\\client\d$\GitHub\AURA\.git\objects\9a;', ...
     '\\client\d$\GitHub\AURA\.git\objects\a3;', ...
     '\\client\d$\GitHub\AURA\.git\objects\a4;', ...
     '\\client\d$\GitHub\AURA\.git\objects\ab;', ...
     '\\client\d$\GitHub\AURA\.git\objects\ad;', ...
     '\\client\d$\GitHub\AURA\.git\objects\ae;', ...
     '\\client\d$\GitHub\AURA\.git\objects\b5;', ...
     '\\client\d$\GitHub\AURA\.git\objects\b8;', ...
     '\\client\d$\GitHub\AURA\.git\objects\bb;', ...
     '\\client\d$\GitHub\AURA\.git\objects\bf;', ...
     '\\client\d$\GitHub\AURA\.git\objects\c3;', ...
     '\\client\d$\GitHub\AURA\.git\objects\c4;', ...
     '\\client\d$\GitHub\AURA\.git\objects\c6;', ...
     '\\client\d$\GitHub\AURA\.git\objects\ce;', ...
     '\\client\d$\GitHub\AURA\.git\objects\d0;', ...
     '\\client\d$\GitHub\AURA\.git\objects\d3;', ...
     '\\client\d$\GitHub\AURA\.git\objects\da;', ...
     '\\client\d$\GitHub\AURA\.git\objects\e1;', ...
     '\\client\d$\GitHub\AURA\.git\objects\ef;', ...
     '\\client\d$\GitHub\AURA\.git\objects\f4;', ...
     '\\client\d$\GitHub\AURA\.git\objects\info;', ...
     '\\client\d$\GitHub\AURA\.git\objects\pack;', ...
     '\\client\d$\GitHub\AURA\.git\refs;', ...
     '\\client\d$\GitHub\AURA\.git\refs\heads;', ...
     '\\client\d$\GitHub\AURA\.git\refs\remotes;', ...
     '\\client\d$\GitHub\AURA\.git\refs\remotes\origin;', ...
     '\\client\d$\GitHub\AURA\.git\refs\tags;', ...
     '\\client\d$\GitHub\AURA\AC_Flyback;', ...
     '\\client\d$\GitHub\AURA\BuckBoost;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck\slprj;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck\slprj\sim;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck\slprj\sim\varcache;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck\slprj\sim\varcache\Buck_COMPEL_2019;', ...
     '\\client\d$\GitHub\AURA\COMPEL Buck\slprj\sim\varcache\Buck_COMPEL_2019\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\COMPEL HDCS;', ...
     '\\client\d$\GitHub\AURA\DAB_simulink;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck\slprj;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck\slprj\sim;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck\slprj\sim\varcache;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck\slprj\sim\varcache\Buck_COMPEL_2019;', ...
     '\\client\d$\GitHub\AURA\DMC 2021_3LEVELBuck\slprj\sim\varcache\Buck_COMPEL_2019\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\EPC9118;', ...
     '\\client\d$\GitHub\AURA\EVAL-CN0342-EB1Z;', ...
     '\\client\d$\GitHub\AURA\MR_Buck;', ...
     '\\client\d$\GitHub\AURA\SC Fibb;', ...
     '\\client\d$\GitHub\AURA\Spence WPT;', ...
     '\\client\d$\GitHub\AURA\Spence WPT\functions;', ...
     '\\client\d$\GitHub\AURA\Spence WPT\functions\addaxisFunction;', ...
     '\\client\d$\GitHub\AURA\circuit parsing;', ...
     '\\client\d$\GitHub\AURA\circuit parsing\NetLists;', ...
     '\\client\d$\GitHub\AURA\circuit parsing\TestCases;', ...
     '\\client\d$\GitHub\AURA\slprj;', ...
     '\\client\d$\GitHub\AURA\slprj\sim;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\BuckBoost;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\BuckBoost\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Buck_COMPEL_2019;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Buck_COMPEL_2019\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Buckboost_COMPEL_2020_SS;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Buckboost_COMPEL_2020_SS\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\COMPEL_2019_HDSC;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\COMPEL_2019_HDSC\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\DAB_COMPEL_2019;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\DAB_COMPEL_2019\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\EPC9118_Buck;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\EPC9118_Buck\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Flyback_PLECS_Model;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Flyback_PLECS_Model\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Flyback_PLECS_Model_EVAL;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\Flyback_PLECS_Model_EVAL\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\PLECS_MR_Buck;', ...
     '\\client\d$\GitHub\AURA\slprj\sim\varcache\PLECS_MR_Buck\tmwinternal;', ...
     '\\client\d$\GitHub\AURA\state space analysis;', ...
     '\\client\d$\GitHub\AURA\state space analysis\Test Cases;', ...
     '\\client\d$\GitHub\AURA\state space analysis\Test Cases\Outputs;', ...
     '\\client\d$\GitHub\AURA\state space analysis\Test Cases\Parameters;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\PreviousApplications;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\PreviousApplications\DicksonSweep;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\PreviousApplications\InverterLoadPull;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\PreviousApplications\LossExtraction;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\PreviousApplications\VRMoptimization;', ...
     '\\client\d$\GitHub\AURA\state space analysis\testConverters\SC_Fibb;', ...
     'C:\Users\jbaxte24\AppData\Local\Temp\27\Editor_ptyvc;', ...
