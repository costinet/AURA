...
try
    ...
    if I == 3 && the_sign == -1
        ...
        errorCoss = FETs(:,2)<=FETs(x(i),2);
            ...
            [stick_em,graph1]=DMC_Buck_SC_D_Sweep(x_test,Coss_adj_test,Ron_adj_test);
