% This script saves a converter class to run as a test case
clear

cd('D:\GitHub\AURA\state space analysis\Test Cases\Parameters')
...
conv.Switch_Sequence = Binary_for_DAB;
