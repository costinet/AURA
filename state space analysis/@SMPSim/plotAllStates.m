...
%PLOTALLSTATES is a SMPSim function that plots all of the state variables across the entire period
%   plotAllStates(plot#) plots all of the state variables as subplots under the plot
%   number specified
%
%   See also PLOTALLOUTPUTS
