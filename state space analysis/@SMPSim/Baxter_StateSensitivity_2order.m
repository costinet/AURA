function [dXs1,dXs2,dX] = Baxter_StateSensitivity_2order(obj,keep_SS, varToPerturb, pI, dX, cI)
...
[dXs2] = obj.SS_Soln(keep_SS,As,Bs,ts,u); 
[dXs2] = obj.CorrectXs(keep_SS,dXs2);

    ts(pI) = ts(pI) - dX/2;
    ts(cI) = ts(cI) - dX2/2;

[dXs1] = obj.SS_Soln(keep_SS,As,Bs,ts,u); 
[dXs1] = obj.CorrectXs(keep_SS,dXs1);
