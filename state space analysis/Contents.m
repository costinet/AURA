...
% Version 0.3.4 15-Oct-2025
% 
% Toolbox scripts
%   updateToolbox - get and install latest release from github
%
% Toolbox classes
%   @SMPStopology   - SMPS topology class, containing schematic information
%   @SMPSconverter  - SMPS converter class, containing topology and modulation
%   @SMPSim         - SMPS simulator class, containting converter and steady-state solution 
%   
% Folders
