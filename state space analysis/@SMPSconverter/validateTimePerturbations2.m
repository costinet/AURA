...
% VALIDATETIMEPERTUBATION2 if a function of the SMPSconverter class that
% ensures time intervals changes will result in zero alterations to
% frquency and result in no negative time intervals



    %Altered by Baxter to adjust the tr parameter to be not included in
    %function so that it can be changed externally to get quicker solves
    %for findValidSteadyState.m
