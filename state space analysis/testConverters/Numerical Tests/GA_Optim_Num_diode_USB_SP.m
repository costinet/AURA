...
options = optimoptions('ga','PlotFcn',@gaplotbestf,'TolCon',1e-9,'Display','iter',...
    'MaxGenerations',100,'MaxTime',60*60*1, 'MaxStallGenerations',50, 'PopulationSize', 10);
...
[x,fval,exitflag,output,population,scores] = ...
    ga(@AURA_Eff_Sweep_IC_reduce_USB_SP, Nvars, A, b, Aeq, beq, LB.*sf, UB.*sf, [], INTCON, options);
