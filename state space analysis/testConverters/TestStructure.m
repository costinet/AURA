...
if(allAssess && niter <= 250)
    disp(['Model ' PLECsModel{selectedModel} ' converged after ' num2str(niter+1) ' iterations']);
elseif allAssess
    disp(['Model ' PLECsModel{selectedModel} ' DID NOT converge within ' num2str(niter+1) ' iterations']);
end
end
